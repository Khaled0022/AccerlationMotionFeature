...
INT8U MCP_CAN::mcp2515_init(const INT8U canIDMode, const INT8U canSpeed, const INT8U canClock)
{
  ...
  INT8U res;
    ...
    {
#if DEBUG_MODE
      Serial.println(F("MCP2515 Entering Configuration Mode Failure...")); 
#endif
      return res;
    }
#if DEBUG_MODE
    Serial.println(F("MCP2515 Entering Configuration Mode Successful!"));
#endif
    ...
    {
#if DEBUG_MODE
      Serial.println(F("MCP2515 Setting Baudrate Failure..."));
#endif
      return res;
    }
#if DEBUG_MODE
    Serial.println(F("MCP2515 Setting Baudrate Successful!"));
#endif
...
*/
            ...
            default:
#if DEBUG_MODE        
            Serial.println(F("MCP2515 Setting ID Mode Failure..."));
#endif           
            return MCP2515_FAIL;
            break;
}    
        ...
        {
#if DEBUG_MODE        
          Serial.println(F("MCP2515 Returning to Previous Mode Failure..."));
#endif           
          return res;
        }
...
INT8U MCP_CAN::init_Mask(INT8U num, INT8U ext, INT32U ulData)
{
...
#if DEBUG_MODE
    Serial.println(F("MCP2515 Starting to Set Mask!"));
#endif
    res = mcp2515_setCANCTRL_Mode(MODE_CONFIG);
    if(res > 0){
#if DEBUG_MODE
    ...
    if(res > 0){
#if DEBUG_MODE
    Serial.println(F("MCP2515 Entering Previous Mode Failure...")); 
	Serial.println(F("MCP2515 Setting Mask Failure..."));
#endif
	return res;
    }
#if DEBUG_MODE
    Serial.println(F("MCP2515 Setting Mask Successful!"));
#endif
    return res;
}
...
INT8U MCP_CAN::init_Filt(INT8U num, INT8U ext, INT32U ulData)
{
    INT8U res = MCP2515_OK;
#if DEBUG_MODE
    Serial.println(F("MCP2515 Starting to Set Filter!"));
#endif
    res = mcp2515_setCANCTRL_Mode(MODE_CONFIG);
    if(res > 0)
    {
#if DEBUG_MODE
      Serial.println(F("MCP2515 Enter Configuration Mode Failure...")); 
#endif
      return res;
    }
...
#if DEBUG_MODE
    Serial.println(F("MCP2515 Entering Previous Mode Failure...")); 
	Serial.println(F("MCP2515 Setting Filter Failure..."));
#endif
      return res;
    }
#if DEBUG_MODE
    Serial.println(F("MCP2515 Setting Filter Successful!"));
#endif
...
INT8U MCP_CAN::init_Filt(INT8U num, INT32U ulData)
{
    ...
    {
#if DEBUG_MODE
    Serial.println(F("EMCP2515 ntering Previous Mode Failure...")); 
	Serial.println(F("MCP2515 Setting Filter Failure..."));
#endif
      return res;
    }
